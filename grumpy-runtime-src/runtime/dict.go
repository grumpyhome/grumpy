...
func (d *Dict) writeEntry(f *Frame, index int, entry dictEntry, overwrite bool) (prevEntry dictEntry, ok bool) {
...
top:
	...
	if raised == nil {
		...
		} else if prevEntry, ok := d.writeEntry(f, index, dictEntry{hashValue, entryKey, value}, overwrite); ok {
